...
OUT_DIR = ROOT / "obb_reconstruction_inputs" / "yolo26_9class_edge_anchor_refit"
VIS3D_OVERLAY_DIR = OUT_DIR / "visualizations_3d_overlays"


HYPOTHESES = [
    {"name": "center_identity", "anchor": "center", "rotation": "identity", "extent0": [0.05, 0.05, 0.05], "prior_weight": 0.22},
    {"name": "bottom_upright", "anchor": "bottom_center", "rotation": "upright", "extent0": [0.05, 0.05, 0.20], "prior_weight": 0.26},
    {"name": "top_camera", "anchor": "top_center", "rotation": "camera_facing", "extent0": [0.05, 0.05, 0.12], "prior_weight": 0.22},
    {"name": "left_camera", "anchor": "left_center", "rotation": "camera_facing", "extent0": [0.08, 0.03, 0.05], "prior_weight": 0.24},
    {"name": "right_camera", "anchor": "right_center", "rotation": "camera_facing", "extent0": [0.08, 0.03, 0.05], "prior_weight": 0.24},
    {"name": "tl_planar", "anchor": "top_left", "rotation": "planar_facing", "extent0": [0.06, 0.01, 0.05], "prior_weight": 0.28},
    {"name": "tr_planar", "anchor": "top_right", "rotation": "planar_facing", "extent0": [0.06, 0.01, 0.05], "prior_weight": 0.28},
    {"name": "bl_upright", "anchor": "bottom_left", "rotation": "upright", "extent0": [0.06, 0.03, 0.18], "prior_weight": 0.28},
    {"name": "br_upright", "anchor": "bottom_right", "rotation": "upright", "extent0": [0.06, 0.03, 0.18], "prior_weight": 0.28},
...
def observation_anchor(obs, mode):
    ...
    return table.get(mode, table["center"])
...
def fit_hypothesis(observations, K, poses, hyp):
    ...
    per_obs = observation_edge_residuals(observations, K, poses, center1, extent1, R0)
    ...
    per_obs2 = observation_edge_residuals(observations, K, poses, center2, extent2, R0)
...
def plot_3d_scene(obb_results, poses, out_path):
    ...
    ax.set_ylabel("Y")
    ax.set_zlabel("Z")
    ax.set_title("Edge/Corner Anchor 3D OBB Refit")
...
def main():
    ...
    (OUT_DIR / "metadata.json").write_text(json.dumps({
        ...
        "notes": [
            ...
            "Hypotheses used center, edges, and corners as ray anchors for initialization.",
            "Optimization loss used normalized left/right/top/bottom reprojection residuals.",
    ...
    print(f"Wrote edge-anchor refit outputs to {OUT_DIR}")
